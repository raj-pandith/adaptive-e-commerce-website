...
var module = {};
(function main(global, module$1, isWorker, workerSize) {
	...
	function promise(func) {
		var ModulePromise = module$1.exports.Promise;
	...
	var getWorker = (function() {
		...
		function decorate(worker$1) {
			...
			worker$1.init = function initWorker(canvas) {
				var offscreen = canvas.transferControlToOffscreen();
				worker$1.postMessage({ canvas: offscreen }, [offscreen]);
			};
			worker$1.fire = function fireWorker(options, size, done) {
				if (prom) {
				...
				prom = promise(function(resolve) {
					function workerDone(msg) {
						...
						delete resolves[id];
						worker$1.removeEventListener("message", workerDone);
						prom = null;
						bitmapMapper.clear();
						done();
						resolve();
					}
					worker$1.addEventListener("message", workerDone);
					execute(options, id);
					resolves[id] = workerDone.bind(null, { data: { callback: id } });
				});
				return prom;
			};
			worker$1.reset = function resetWorker() {
				worker$1.postMessage({ reset: true });
	...
	function animate(canvas, fettis, resizer, size, done) {
		...
		return {
			addFettis: function(fettis$1) {
				animatingFettis = animatingFettis.concat(fettis$1);
				return prom;
			},
			canvas,
			promise: prom,
	...
	module$1.exports.reset = function() {
		getDefaultFire().reset();
	};
	module$1.exports.create = confettiCannon;
	module$1.exports.shapeFromPath = shapeFromPath;
	module$1.exports.shapeFromText = shapeFromText;
})((function() {
